...
class NominationController extends Controller
{
    public function membershipType()
    {
        ...
        return view('dashboard.nomination.membership_type.index', ['memberhip_type' => $memberhip_type]);
    }
    ...
    public function editMembershipType($uuid)
    {
        ...
        return view('dashboard.nomination.membership_type.edit', ['memberhip_type' => $memberhip_type]);
    }
    ...
    public function membershipPosition()
    {
        ...
        return view('dashboard.nomination.membership_position.index', ['memberhip_type' => $memberhip_type, 'memberhip_position' => $memberhip_position]);
    }
    ...
    public function editMembershipPosition($uuid)
    {
        ...
        return view('dashboard.nomination.membership_position.edit', ['memberhip_position' => $memberhip_position, 'memberhip_type' => $memberhip_type]);
    }
    public function createNomination()
    {
        ...
        return view('dashboard.nomination.create', ['memberhip_position' => $memberhip_position]);
    }
    public function storeNomination(Request $request)
    {
        ...
        try {
            ...
            $nomination->save();
            if ($nomination->save()) {
                if (count($request->membership_position_uuid) > 0) {
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('dashboard.nomination.dashboard', ['nomination' => $nomination, 'all_nomination_list' => $all_nomination_list, 'nomination_progress_chart' => $nomination_progress_chart, 'total_customer' => $total_customer]);
    }
    public function manageNominationContent()
    {
        ...
        return view('dashboard.nomination.manage-content', ['content' => $content]);
    }
    ...
    public function nominationPositionDetails($uuid)
    {
        ...
        if (count($nomination_member_ids) > 0) {
        ...
        return view('dashboard.nomination.position-details', ['total_customer' => $total_customer, 'check_details' => $check_details, 'member_nomination' => $member_nomination]);
    }
    ...
    public function customerNominationList($uuid, $member_id)
    {
        ...
        return view('dashboard.nomination.nomination_customer', ['check_details' => $check_details, 'customer_nomination' => $customer_nomination]);
    }
