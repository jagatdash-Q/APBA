...
class CreateOurTeamListingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('our_team_listings', function (Blueprint $table) {
            $table->id();
            $table->string('uid')->nullable();
            $table->string('our_teams_uid')->nullable();
            $table->integer('lock_acquired_by')->nullable();
            $table->enum('page_type',['our_teams_listing'])->nullable();
    ...
    {
        Schema::dropIfExists('our_team_listings');
    }
}
