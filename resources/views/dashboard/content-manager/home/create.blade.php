...
@section('title', __('Create Home Page Content'))
@push('after-styles')
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3>{{ __('Create Home Page Content') }}</h3>
                <small>
            ...
            <div class="row mt-2">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('admin.content.home.page.create') }}" method="POST" id="homepage_form" onsubmit="return validateForm();">
                            @csrf
                            <input type="hidden" name="base_url" id="base_url" value="{{ url('') }}">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                ...
                                                oninput="generatePageSlug(this.value,'page_slug','home','draft_btn','submit_btn')"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        <label class=" form-control-label"> Page Slug<span
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        <label class=" form-control-label"> Meta Keyword<span
                                            class="text-danger">*</span> </label>
                                    </div>
                                    <div class="col-sm-10">
                                        <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="heading"> Heading <span
                                            class="text-danger">*</span></label>
                                        <input type="text" class="form-control form-control-user" id="section_1_heading"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="section_1_desc"> Description <span
                                            class="text-danger">*</span></label>
                                        <textarea name="section_1_desc" class="form-control" id="section_1_desc"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="section_2_desc"> Description <span
                                            class="text-danger">*</span></label>
                                        <textarea name="section_2_desc" class="form-control" id="section_2_desc"></textarea>
                                    </div>
                                </div>
