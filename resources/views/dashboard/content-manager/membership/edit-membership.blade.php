...
@section('title', __('Edit Membership Page Content'))
@push('after-styles')
    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="row mt-2">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('admin.update.membership') }}" method="POST" id="membership_form"
                            onsubmit="return validateForm();">
                            @csrf
                            <input type="hidden" name="base_url" id="base_url" value="{{ url('') }}">
                            <input type="hidden" name="membership_id" id="membership_id" value="{{ $mebership->id }}">
                            <input type="hidden" name="content_id" id="content_id" value="{{ $mebership->content_id }}">
                            <input type="hidden" name="membership_sec_len" id="membership_sec_len"
                                value="{{ count($mebership->getMemberships) }}">
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                ...
                                                oninput="generatePageSlug(this.value,'page_slug','membership','draft_btn','submit_btn','{{ $mebership->page_name }}')"
                                                value="{{ $mebership->page_name }}"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                ...
                                                value="{{ $mebership->page_slug }}" readonly></span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10"> <span class="pr-field"><input placeholder=""
                                                ...
                                                value="{{ $mebership->meta_title }}" type="text"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                ...
                                                value="{{ $mebership->meta_keyword }}"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                ...
                                                value="{{ $mebership->meta_description }}"></span>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="card-body" style="padding:10px">
                                    ...
                                    <div class="" style="padding:10px">
                                        ...
                                        <span class="pr-field"><input type="text" class="form-control text-secondary"
                                                ...
                                                value="{{ $mebership->banner_desc }}"></span>
                                    </div>
                                    <div class="" style="padding:10px">
                                        ...
                                        <span class="pr-field"><input type="url" class="form-control text-secondary"
                                                ...
                                                value="{{ $mebership->button_link }}"></span>
                                    </div>
                                    <div class="" style="padding:10px">
                                        ...
                                        <span class="pr-field"><input type="text" class="form-control text-secondary"
                                                ...
                                                value="{{ $mebership->button_name }}"></span>
                                    </div>
                                    <div class="mb-3" style="padding:10px">
                                        ...
                                        <div class="row col-md-10" style="margin-left:0px">
                                            ...
                                            <div style="width: 18%;float:right;    margin-left: 15px;">
                                                @if ($mebership->getBannerImageWeb != null)
                                                    @if (in_array($mebership->getBannerImageWeb->file_ext, ['mp4', 'webm', 'ogg']))
                                                        <img src="{{ asset('assets/dashboard/images/demo_img.jpg') }}"
                                                            id="banner_image_web_preview" height="100px"
                                                            width="auto" />
                                                    @else
                                                        <img src="{{ asset('') }}{{ $mebership->getBannerImageWeb->path }}"
                                                            id="banner_image_web_preview" height="100px"
                                                            width="auto" />
                                                    @endif
                                                @else
                                    ...
                                    <div class="mb-3" style="padding:10px">
                                        ...
                                        <div class="row col-md-10" style="margin-left:0px">
                                            ...
                                            <div style="width: 18%;float:right;    margin-left: 15px;">
                                                @if ($mebership->getBannerImageTab != null)
                                                    @if (in_array($mebership->getBannerImageTab->file_ext, ['mp4', 'webm', 'ogg']))
                                                        <img src="{{ asset('assets/dashboard/images/demo_img.jpg') }}"
                                                            id="banner_image_tablet_preview" height="100px"
                                                            width="auto" />
                                                    @else
                                                        <img src="{{ asset('') }}{{ $mebership->getBannerImageTab->path }}"
                                                            id="banner_image_tablet_preview" height="100px"
                                                            width="auto" />
                                                    @endif
                                                @else
                                    ...
                                    <div class="mb-3" style="padding:10px">
                                        ...
                                        <div class="row col-md-10" style="margin-left:0px">
                                            ...
                                            <div style="width: 18%;float:right;    margin-left: 15px;">
                                                @if ($mebership->getBannerImageMobile != null)
                                                    @if (in_array($mebership->getBannerImageMobile->file_ext, ['mp4', 'webm', 'ogg']))
                                                        <img src="{{ asset('assets/dashboard/images/demo_img.jpg') }}"
                                                            id="banner_image_mobile_preview" height="100px"
                                                            width="auto" />
                                                    @else
                                                        <img src="{{ asset('') }}{{ $mebership->getBannerImageMobile->path }}"
                                                            id="banner_image_mobile_preview" height="100px"
                                                            width="auto" />
                                                    @endif
                                                @else
                                            ...
                                            <div class="tab-pane active" id="img_prev_tab__web_" aria-expanded="true">
                                                <div id="parent_div_web_"
                                                    ...
                                                    <span id="draggable_web_" class="banner-text-lg draggable_text1"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->banner_title_left_pos_web }}%;top:{{ $mebership->banner_title_top_pos_web }}%">
                                                        @if ($mebership->banner_title != '')
                                                            {{ $mebership->banner_title }}
                                                        @else
                                                            Banner Title
                                                        @endif
                                                    </span>
                                                    ...
                                                    <span id="draggable2_web_"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->banner_desc_left_pos_web }}%;top:{{ $mebership->banner_desc_left_pos_web }}%">
                                                        @if ($mebership->banner_desc != '')
                                                            {{ $mebership->banner_desc }}
                                                        @else
                                                            Banner Desc
                                                        @endif
                                                    </span>
                                                    ...
                                                    <a id="draggable3_web_" class="trasparent-btn-white draggable_text3"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->button_name_left_pos_web }}%;top:{{ $mebership->button_name_top_pos_web }}%">
                                                        @if ($mebership->button_name != '')
                                                            {{ $mebership->button_name }}
                                                        @else
                                                            Button
                                                        @endif
                                                    </a>
                                            ...
                                            <div class="tab-pane" id="img_prev_tab__tablet_" aria-expanded="true">
                                                <div id="parent_div_tablet_"
                                                    ...
                                                    <span id="draggable_tablet_" class="banner-text-md draggable_text1"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->banner_title_left_pos_tablet }}%;top:{{ $mebership->banner_title_top_pos_tablet }}%">
                                                        @if ($mebership->banner_title != '')
                                                            {{ $mebership->banner_title }}
                                                        @else
                                                            Banner Title
                                                    ...
                                                    <span id="draggable2_tablet_"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->banner_desc_left_pos_tablet }}%;top:{{ $mebership->banner_desc_top_pos_tablet }}%">
                                                        @if ($mebership->banner_desc != '')
                                                            {{ $mebership->banner_desc }}
                                                        @else
                                                            Banner Description
                                                    ...
                                                    <a id="draggable3_tablet_"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->button_name_left_pos_tablet }}%;top:{{ $mebership->button_name_top_pos_tablet }}%">
                                                        @if ($mebership->button_name != '')
                                                            {{ $mebership->button_name }}
                                                        @else
                                                            Button
                                            ...
                                            <div class="tab-pane " id="img_prev_tab__mobile_" aria-expanded="true">
                                                <div id="parent_div_mobile_"
                                                    ...
                                                    <span id="draggable_mobile_" class="banner-text-sm draggable_text1"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->banner_title_left_pos_mobile }}%;top:{{ $mebership->banner_title_top_pos_mobile }}%">
                                                        @if ($mebership->banner_title != '')
                                                            {{ $mebership->banner_title }}
                                                        @else
                                                            Banner Title
                                                    ...
                                                    <span id="draggable2_mobile_"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->banner_desc_left_pos_mobile }}%;top:{{ $mebership->banner_desc_top_pos_mobile }}%">
                                                        @if ($mebership->banner_desc != '')
                                                            {{ $mebership->banner_desc }}
                                                        @else
                                                            Banner Description
                                                    ...
                                                    <a id="draggable3_mobile_"
                                                        ...
                                                        style="position:absolute;color:white; cursor: move;left:{{ $mebership->button_name_left_pos_mobile }}%;top:{{ $mebership->button_name_top_pos_mobile }}%">
                                                        @if ($mebership->button_name != '')
                                                            {{ $mebership->button_name }}
                                                        @else
                                                            Button
                            ...
                            <fieldset>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="welcome_head"
                                            ...
                                            value="{{ $mebership->section_1_head }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea name="welcome_desc" class="form-control" id="welcome_desc">{{ $mebership->section_1_desc }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row col-md-10" style="margin-left:0px">
                                    <div style="width:80%;float:left">
                                        @if ($mebership->getfirstSectionImage != null)
                                            <input type="text" id="section_1_image" name="section_1_image"
                                                class="form-control" readonly style="margin-bottom:15px"
                                                value="{{ $mebership->getfirstSectionImage->file_name }}">
                                        @else
                                            <input type="text" id="section_1_image" name="section_1_image"
                                    ...
                                    <div style="width: 18%;float:right;    margin-left: 15px;">
                                        @if ($mebership->getfirstSectionImage != null)
                                            @if (in_array($mebership->getfirstSectionImage->file_ext, ['mp4', 'webm', 'ogg']))
                                                <img src="{{ asset('assets/dashboard/images/demo_img.jpg') }}"
                                                    id="section_1_image_preview" height="100px" width="auto" />
                                            @else
                                                <img src="{{ asset('') }}{{ $mebership->getfirstSectionImage->path }}"
                                                    id="section_1_image_preview" height="100px" width="auto" />
                                            @endif
                                        @else
                                            <img src="{{ asset('assets/dashboard/images/image_not_found.png') }}"
                            ...
                            <fieldset>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                            ...
                                            name="section_2_heading" value="{{ $mebership->section_2_head }}">
                                    </div>
                                </div>
                                ...
                                <div id="section_2_membership_container">
                                    @if (count($mebership->getMemberships))
                                        @foreach ($mebership->getMemberships as $index => $mem)
                                            @php $index++; @endphp
                                            <div class="membership-sec">
                                                <input type="hidden" name="membership_id_{{ $index }}"
                                                    id="membership_id_{{ $index }}"
                                                    value="{{ $mem->id }}" />
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <label class="form-label"
                                                            for="membership_name_{{ $index }}">Membership
                                                            Name</label>
                                                        <input type="text"
                                                            class="form-control form-control-user membership_name"
                                                            id="membership_name_{{ $index }}"
                                                            placeholder="Membership Name"
                                                            name="membership_name_{{ $index }}"
                                                            value="{{ $mem->membership_name }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <label class="form-label"
                                                            for="membership_srt_desc_{{ $index }}">Membership
                                                            Short
                                                            Description</label>
                                                        <input type="text"
                                                            class="form-control form-control-user membership_srt_desc"
                                                            id="membership_srt_desc_{{ $index }}"
                                                            placeholder="Membership Short Description"
                                                            name="membership_srt_desc_{{ $index }}"
                                                            value="{{ $mem->membership_srt_desc }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row" style="margin-left:0!important">
                                                    <label
                                                        style="margin-right: 10px;margin-bottom:0px !important">Membership
                                                        Type</label>

                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="membership_subscription_type_{{ $index }}"
                                                            id="membership_subscription_type_{{ $index }}_1"
                                                            value="sub"
                                                            @if ($mem->subscription_type == 'sub') checked @endif>
                                                        <label class="form-check-label"
                                                            for="membership_subscription_type_{{ $index }}_1">Subscribe</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="membership_subscription_type_{{ $index }}"
                                                            id="membership_subscription_type_{{ $index }}_2"
                                                            value="con"
                                                            @if ($mem->subscription_type == 'con') checked @endif>
                                                        <label class="form-check-label"
                                                            for="membership_subscription_type_{{ $index }}_1">Contact
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row" style="margin-left:0!important">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="membership_plan_{{ $index }}"
                                                            id="membership_plan_{{ $index }}_1" value="yearly"
                                                            @if ($mem->membership_plan == 'yearly') checked @endif>
                                                        <label class="form-check-label"
                                                            for="membership_plan_{{ $index }}_1">Yearly</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="membership_plan_{{ $index }}"
                                                            id="membership_plan_{{ $index }}_2" value="lifetime"
                                                            @if ($mem->membership_plan == 'lifetime') checked @endif>
                                                        <label class="form-check-label"
                                                            for="membership_plan_{{ $index }}_1">Lifetime
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                        <label class="form-label" for="banner_image_web"> Membership
                                                            Image:</label>
                                                    </div>
                                                    ...
                                                    <div class="row col-md-10" style="margin-left:0px">
                                                        <div style="width:80%;float:left">
                                                            @if ($mem->getMembershipImage != null)
                                                                <input type="text"
                                                                    id="membership_image_{{ $index }}"
                                                                    name="membership_image_{{ $index }}"
                                                                    class="form-control membership_image" readonly
                                                                    style="margin-bottom:15px"
                                                                    value="{{ $mem->getMembershipImage->file_name }}">
                                                            @else
                                                                <input type="text"
                                                                    id="membership_image_{{ $index }}"
                                                                    name="membership_image_{{ $index }}"
                                                            ...
                                                            <div class="btn btn-success mt-2 btn-sm btn-round"
                                                                id="banner" class="lib" data-target="#showsModal"
                                                                data-toggle="modal"
                                                                onclick="setModalClickBtnId(document.getElementById('membership_image_{{ $index }}'),'','','' )">
                                                                Select or upload Image </div>
                                                        </div>
                                                        <div style="width: 18%;float:right;margin-left:5px;">
                                                            @if ($mem->getMembershipImage != null)
                                                                @if (in_array($mem->getMembershipImage->file_ext, ['mp4', 'webm', 'ogg']))
                                                                    <img src="{{ asset('assets/dashboard/images/demo_img.jpg') }}"
                                                                        id="membership_image_{{ $index }}_preview"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <label class="form-label"
                                                            for="membership_price_{{ $index }}">Membership
                                                            Price</label>
                                                        <input type="integer"
                                                            class="form-control form-control-user membership_price"
                                                            id="membership_price_{{ $index }}"
                                                            placeholder="Membership Price"
                                                            name="membership_price_{{ $index }}"
                                                            value=" {{ $mem->membership_price }} ">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <label class="form-label"
                                                            for="membership_button_{{ $index }}">Membership
                                                            Button
                                                            Text</label>
                                                        <input type="text"
                                                            class="form-control form-control-user membership_button"
                                                            id="membership_button_{{ $index }}"
                                                            placeholder="Membership Button Text"
                                                            name="membership_button_{{ $index }}"
                                                            value=" {{ $mem->membership_button_text }} ">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <label class="form-label"
                                                            for="membership_desc_{{ $index }}">Membership
                                                            Description</label>
                                                        <textarea name="membership_desc_{{ $index }}" id="membership_desc_{{ $index }}"> {{ $mem->membership_description }} </textarea>
                                                    </div>
                                                </div>
                                                {{-- <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="deleteMembership('{{ $mem->id }}')">Remove</button>
                                                    </div>
                                                </div> --}}
                                            </div>
                                        @endforeach
...
@push('after-scripts')
    ...
    <script>
        let i = "{{ count($mebership->getMemberships) }}";
        $(document).ready(function() {
            ...
            @foreach ($mebership->getMemberships as $index => $mem)
                @php $index++ @endphp
                CKEDITOR.replace('membership_desc_{{ $index }}', {
                    filebrowserUploadUrl: "{{ route('ck.upload', ['_token' => csrf_token()]) }}",
                    filebrowserUploadMethod: 'form'
                });
            @endforeach
        ...
        let deleteMembership = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.membership-package.delete') }}",
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}",
                            'id': id,
