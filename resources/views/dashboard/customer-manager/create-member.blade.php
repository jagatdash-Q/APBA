...
@section('content')
    ...
    <div class="padding">
        ...
        <div class="row">
            <div class="container">
                <div class="card pt-2">
                    <form action="{{ route('admin.store.member') }}" method="post" onsubmit="return checkConfirmPass()" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 mt-2">
                                    ...
                                    <span class="pr-field"><input type="text" class="form-control text-secondary"
                                            name="last_name" id="last_name" placeholder="Enter last name" required></span>
                                </div>
                                <div class="col-6 mt-2">
                                ...
                                <div class="col-6 mt-2">
                                    ...
                                    <span class="pr-field"> <input type="email" class="form-control text-secondary"
                                            placeholder="Your email address" name="email" id="email"
                                            value="{{ old('email') }}" required></span>
                                </div>
                                <div class="col-6 mt-2">
                                    <label class="form-label" for="last_name">Password<span id="danger">*</span></label>
                                    <span class="pr-field"> <input type="password" class="form-control text-secondary"
                                            placeholder="Your password" name="password" id="password"
                                            value="{{ old('password') }}" required></span>
                                </div>
                                <div class="col-6 mt-2">
                                    <label class="form-label" for="last_name">Confirm Password<span
                                            id="danger">*</span></label>
                                    <span class="pr-field"> <input type="password" class="form-control text-secondary"
                                    ...
                                    <span class="pr-field ml-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="nomination"
                                                id="nomination" value="yes" checked>
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <span class="pr-field ml-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="payment_mode"
                                                id="payment_mode" value="others">
                                            <label class="form-check-label" for="payment_mode">Others</label>
                                        </div>
