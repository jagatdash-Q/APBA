...
@section('title', __('Election Content Details'))
@section('content')
    @push('after-styles')
        ...
        <div class="box">
            ...
            <div class="card">
                <div class="card-header" style="font-size: 18px;">
                    ...
                    </span>Manage Election Content
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('admin.election.create.content') }}" method="post"
                                ...
                                <fieldset class="fieldset-design">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                    ...
                                                    value="@if ($content != null) {{ $content->heading }} @endif"
                                                    ></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-12"> <label class="form-control-label"> Election Details
                                            </label>
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12"> <label class="form-control-label"> Election Content
                                                Details
                                            </label>
                                        </div>
                                        <div class="col-md-12">
...
@push('after-scripts')
    ...
    <script>
        ...
        let ValidateForm = () => {
            let message = '';
            if ($('#description').val() == '') {
                message = "Election details is required";
            }
            if ($('#content_description').val() == '') {
                message = "Election content details is required";
            }
            if ($('#heading').val() == '') {
