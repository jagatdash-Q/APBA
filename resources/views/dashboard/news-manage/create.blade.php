                                ...
                                <fieldset class="fieldset-design">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                    ...
                                                    oninput="generatePageSlug(this.value,'news_slug','news','draft_btn','submit_btn')"
                                                    value="{{ old('news_name') }}"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-10">
                                            <span class="pr-field"><input placeholder="" class="form-control" dir="ltr"
                                                    ...
                                                    value="{{ old('news_slug') }}" readonly></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <span class="pr-field"><input placeholder="" class="form-control"
                                                    ...
                                                    type="text" value="{{ old('meta_description') }}"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 no-drag">
                                            <input type="hidden" name="news_desc" id="news_desc" />
                                            <input type="hidden" name="news_desc_data" id="news_desc_data" />
                                            <div id="news_gjs"></div>
                                        </div>
                                    </div>
                                </fieldset>
