...
@section('title', __('Our Teams Category create'))
@section('content')
<style>
    .form-check-input{
    ...
    <div class="padding">
        ...
        <div class="row">
            <div class="container">
                <div class="card pt-2">
                    <form action="{{ route('admin.our_teams.category.store') }}" method="post">
                        @csrf
                        <input type="hidden" name="base_url" id="base_url" value="{{ url('') }}">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="title">Category Name</label>
                                <input type="text" class="form-control form-control-user" id="title" placeholder="Enter category name" name="title" required>
                            </div>
                        </div>
                        <div class="col-md-12">
