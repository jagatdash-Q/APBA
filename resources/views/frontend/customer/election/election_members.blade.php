    ...
    <div class="table_div my-5">
        <table class="table site_table table-borderless">
            ...
            <tbody>
                @if (count($customer_for_voting))
                @foreach ($customer_for_voting as $members)
                    <tr>
                        <td>
                            <div class="nominee_thumb">
                                <img src="{{ $members->profile_pic == '' ? asset('assets/frontend/images/user_thumb.jpg') : asset('uploads/profile_pic/' . $members->profile_pic) }}"
                                    alt="...">
                            </div>
                        </td>
                            ...
                            <div class="d-flex justify-content-center">
                                <a class="nominee_action_btn mr-2" href="{{ $members->social_media_link }}"
                                    ...
                                    <svg width="48" height="48" viewBox="0 0 48 48">
                                        ...
                                        <g id="Group_15107" data-name="Group 15107" transform="translate(-1101 -966)">
                ...
                @else
                <tr>
                    <td colspan="4" class="text-center" style="color: red" id="member_message">No record found</td>
                </tr>
                @endif
            </tbody>
        </table>
