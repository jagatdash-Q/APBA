                                            ...
                                            <tr style="font-family: 'Poppins', sans-serif;">
                                                <td
                                                    ...
                                                    <img style="width: 200px;height: auto; -ms-interpolation-mode: bicubic;margin-top: 15px;margin-bottom: 15px;"
                                                        src="https://a-pba.org/assets/frontend/images/logo.png"
                                                            ...
                                                            <tr style="font-family: 'Poppins', sans-serif;">
                                                                <td class="action-content"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        This is a reminder that your membership with
                                                                        APBA is going to expired on
                                                                        {{ $date }}.</p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        We hope you will take the
                                                                        time to renew your membership and remain a part
                                                                        of our community.</p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        Thank you.</p>
