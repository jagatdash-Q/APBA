                                                            ...
                                                            <tr style="font-family: 'Poppins', sans-serif;">
                                                                <td class="action-content"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        election to recognize the members through our
                                                                        annual Election process.</p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        We invite you to submit your elections for the
                                                                        following positions:</p>

                                                                    @if (count($details['positions']))
                                                                        @foreach ($details['positions'] as $item)
                                                                            <span
                                                                                style="color:#005599; font-size: 14px; font-family: 'Poppins', sans-serif !important; margin-bottom: 15px; margin-top: 0px; line-height: 20px;">{{ $item }}</span><br>
                                                                        @endforeach
                                                                    @endif
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        To elect a member (including yourself),
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        our {{ url('/') }} between
                                                                        {{ $details['voting_start_date'] }} and
                                                                        {{ $details['voting_end_date'] }}.
                                                                    </span><br>
                                                                    <span
                                                                    ...
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        We look forward to receiving your elections
                                                                        and celebrating the achievements of our
                                                                        outstanding members.
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
