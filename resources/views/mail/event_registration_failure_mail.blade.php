                                                            ...
                                                            <tr style="font-family: 'Poppins', sans-serif;">
                                                                <td class="action-content"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        We would like to inform you that there was an
                                                                        issue processing the payment for your event
                                                                        registration for the upcoming event
                                                                        <b>"{{ $details['event_name'] }}"</b> We
                                                                    ...
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        Your event registration is currently incomplete
                                                                        due to the payment failure. To ensure your
                                                                        participation in this exciting event, we kindly
                                                                        request that you take the following steps to
                                                                        resolve this issue:
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        Check Payment Information: Please verify that
                                                                        the payment information provided during
                                                                        registration, including your credit/debit card
                                                                        details, billing address, and card expiration
                                                                        date, is accurate.
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        Payment Method: Ensure that the payment method
                                                                        you used is valid and has sufficient funds
                                                                        available for the transaction.
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        Retry Payment: Visit the registration page by
                                                                        clicking on the following link: <a
                                                                            href="{{ $details['link'] }}" target="_blank">{{ $details['link'] }}</a>
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        If you encounter any difficulties during this
                                                                        process or have questions regarding your
                                                                        payment, please do not hesitate to contact our
                                                                        customer support team. Our dedicated team is
                                                                        ready to assist you in resolving this matter
                                                                        promptly.
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        We appreciate your interest in attending the
                                                                        event and apologize for any inconvenience caused
                                                                        by this payment failure. We look forward to
                                                                        welcoming you to the event once the payment is
                                                                        successfully completed.
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        Thank you for your understanding and prompt
