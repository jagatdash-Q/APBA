                                                            ...
                                                            <tr style="font-family: 'Poppins', sans-serif;">
                                                                <td class="action-content"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        We are delighted to inform you that your payment
                                                                        for the <b>{{ $details['membership_type'] }}</b> with
                                                                        APBA has been successfully processed.
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                    ...
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        <b>Member Name:</b> {{ $details['user_name'] }}
                                                                    </p>

                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        <b>Total Amount Paid:</b>
                                                                        S$ {{ $details['total_amount'] }}
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        <b>Payment Mode:</b>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        with your membership, please feel free to reach
