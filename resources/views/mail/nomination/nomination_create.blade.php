                                                            ...
                                                            <tr style="font-family: 'Poppins', sans-serif;">
                                                                <td class="action-content"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        nomination to recognize the members through our
                                                                        annual Nomination process.</p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        We invite you to submit your nominations for the
                                                                        following positions:</p>

                                                                    @if (count($details['position']))
                                                                        @foreach ($details['position'] as $item)
                                                                            <span
                                                                    ...
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        To nominate a member (including yourself),
