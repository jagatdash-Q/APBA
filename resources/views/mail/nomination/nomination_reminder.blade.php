                                                            ...
                                                            <tr style="font-family: 'Poppins', sans-serif;">
                                                                <td class="action-content"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        We want to remind you about the upcoming
                                                                        deadline for submitting nominations for our
                                                                        organization. This is a reminder that the
                                                                        deadline for nominations is approaching rapidly,
                                                                        and we wouldn't want you to miss out on this
                                                                        opportunity to recognize outstanding members of
                                                                        our community.</p>
                                                                    <span
                                                                        style="color:#4a4a4a; font-size: 14px; font-family: 'Poppins', sans-serif !important; margin-bottom: 15px; margin-top: 0px; line-height: 20px;">Nominations
                                                                        start & end date: {{ $details['start_date'] }} -
                                                                        {{ $details['end_date'] }}
                                                                    </span><br>
                                                                    <span
                                                                        style="color:#4a4a4a; font-size: 14px; font-family: 'Poppins', sans-serif !important; margin-bottom: 15px; margin-top: 0px; line-height: 20px;">Nomination
                                                                        Portal: <a href="{{ url('/') }}/nomination"
                                                                            target="_blank">{{ url('/') . '/nomination' }}</a>
                                                                    </span><br>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        To submit your nominations, please follow these
                                                                        simple steps:</p>
                                                                    <span
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        the nomination form and carefully follow the
                                                                        instructions provided & fill in the required
                                                                        details.
                                                                    </span>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
                                                                        We look forward to receiving your nominations by
                                                                        {{ $details['end_date'] }}.
                                                                    </p>
                                                                    <p
                                                                        style="font-family: 'Poppins', sans-serif !important; font-size: 14px; line-height: 20px;color: #4a4a4a;">
